...
import { LearningPreferencesCard } from "@/components/cards/LearningPreferencesCard";
...
function BioCard({ onEdit }: { onEdit: () => void }) {
  return (
    <section className="rounded-lg border border-outline-variant bg-surface-container p-lg">
      ...
      <p className="mt-md text-body-sm text-on-surface-variant">
        Engineering student interested in web development, programming, and improving practical
        project skills through guided learning sessions.
      </p>
    </section>
  );
}
      ...
      <div className="space-y-lg px-margin-mobile py-lg md:px-margin-desktop">
        ...
        <div className="grid gap-lg 2xl:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]">
          <main className="min-w-0 space-y-lg">
            ...
            <BioCard onEdit={() => setMessage("Edit profile mode enabled.")} />
          </main>
